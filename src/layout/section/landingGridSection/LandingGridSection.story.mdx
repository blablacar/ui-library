...
import carpoolBlaBlaBusLarge from 'layout/section/heroSection/images-for-stories/carpool-bbb-large.svg'
import carpoolBlaBlaBusSmall from 'layout/section/heroSection/images-for-stories/carpool-bbb-small.svg'

import { LandingGridSection } from './index'
...
```jsx
import { LandingGridSection } from '@blablacar/ui-library/build/halfSection'
...
<ArgsTable of={LandingGridSection} />

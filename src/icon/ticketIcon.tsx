...
export const TicketIcon = (props: Icon) => (
  <BaseIcon {...props} viewBox="0 0 24 15">
    <g>
      <path fillRule="nonzero" d="M20.5 7.75c0 1.1 1.1 2.03 2.5 2.03.28 0 .5.23.5.5v4.22a.5.5 0 0 1-.5.5H1a.5.5 0 0 1-.5-.5v-4.22c0-.27.22-.5.5-.5 1.4 0 2.5-.93 2.5-2.03 0-1.1-1.1-2.03-2.5-2.03a.5.5 0 0 1-.5-.5V1C.5.72.72.5 1 .5h22c.28 0 .5.22.5.5v4.22a.5.5 0 0 1-.5.5c-1.4 0-2.5.93-2.5 2.03zm-1 0c0-1.54 1.32-2.8 3-3V1.5h-21v3.25c1.68.2 3 1.46 3 3s-1.32 2.8-3 3V14h21v-3.25c-1.68-.2-3-1.46-3-3z"/>

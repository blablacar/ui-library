...
import StepperFullScreen from './StepperFullScreen'
import Item from '_utils/item'
import ChevronIcon from 'icon/chevronIcon'

describe('StepperFullScreen', () => {
  it('should have a clickable Item with a title and chevron icon', () => {
    const onClick = jest.fn()
    const wrapper = shallow(<StepperFullScreen itemTitle="1 seat" onClick={onClick} />)
  ...
  it('should have a Stepper with display large', () => {
    const wrapper = shallow(<StepperFullScreen itemTitle="1 seat" />)
  ...
  it('should not have the same title and itemTitle for a11y', () => {
    const wrapper = shallow(
      <StepperFullScreen itemTitle="1 seat" title="Choose your number of seats" />,
    )

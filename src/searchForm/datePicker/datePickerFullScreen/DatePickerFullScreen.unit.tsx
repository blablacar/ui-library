...
describe('DatePickerFullScreen', () => {
  it('should have a clickable Item with a title and chevron icon', () => {
    const onClick = jest.fn()
    const wrapper = shallow(<DatePickerFullScreen title="Today" onClick={onClick} />)
  ...
  it('should have a DatePicker in vertical orientation', () => {
    const wrapper = shallow(<DatePickerFullScreen title="Today" />)

...
<Canvas>
  <Story name="with a HTML image">
    <ModalWithButton illustration={<img src="https://cdn.blablacar.com/insurance/assets/2b950c73301c3b8526772644de550035.svg" alt="Illustation description" />} />
  </Story>
  ...
  return (
    <BaseSection>
      ...
      <SuccessModal
        ...
        illustration={<img src="https://cdn.blablacar.com/insurance/assets/2b950c73301c3b8526772644de550035.svg" alt="Illustation description" />}
        confirmLabel="Got it!"
        closeOnEsc
      >
